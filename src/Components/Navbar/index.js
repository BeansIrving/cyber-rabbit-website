      ...
      <Nav>
        <NavbarContainer>
          ...
          <NavBtn>
            ...
            >
              {" "}
              <Features src={transparent}></Features>{" "}
            </NavBtnLink>
            ...
            >
              {" "}
              <CyberLayers src={transparent}></CyberLayers>{" "}
            </NavBtnLink>
            ...
            >
              {" "}
              <Token src={transparentMint}></Token>{" "}
            </NavBtnLink>
            {/* <NavBtnLinks href="https://drive.google.com/file/d/1GMs94j54lXOSgQZK4od-d7XroihlvPnz/view?usp=sharing" target="_blank" rel="noopener"> <Whitepaper src={transparent}></Whitepaper> </NavBtnLinks> */}
            ...
            >
              {" "}
              <Partners src={transparent}></Partners>{" "}
            </NavBtnLink>
