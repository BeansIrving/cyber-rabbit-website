    ...
    <FAQContainer>
      ...
      <FAQContent>
        <FAQRow>
          ...
          <FAQColumnContent data-aos="fade-left">
                ...
                {data.map((item, i) => (
                  <div className="hover">
                    ...
                    <div className="item" onClick={() => toggle(i)}>
                      ...
                      <ImgBottomHide
                        src={selected === i ? null : containerBottom}
                        onClick={() => toggle(i)}
                      />
                      <div
...
export const data = [
  ...
  },
  {
    ...
    answer:
      "a. Genesis Collection - WL Sale: 2 (3 if Supercharged) Public Sale: 2",
    answer2: "b. Main Collection - TBA",
    answer3: "c. 2nd Generation Collection - TBA",
  },
  {
